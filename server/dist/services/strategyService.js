 ...
 */
export const getStrategyConfig = async (userId) => {
 ...
 */
export const updateStrategyConfig = async (userId, updates) => {
 ...
 */
export const resetStrategyToDefaults = async (userId) => {
 ...
 */
export const getStrategyPerformance = async (userId) => {
