...
router.get('/metrics', requireUser(), async (req: Request, res: Response) => {
  try {
...
// Request: {}
// Response: { metrics: IRiskMetrics }
router.post('/metrics/calculate', requireUser(), async (req: Request, res: Response) => {
  try {
...
router.get('/limits', requireUser(), async (req: Request, res: Response) => {
  try {
...
router.put('/limits', requireUser(), async (req: Request, res: Response) => {
  try {
...
router.get('/check-breaches', requireUser(), async (req: Request, res: Response) => {
  try {
